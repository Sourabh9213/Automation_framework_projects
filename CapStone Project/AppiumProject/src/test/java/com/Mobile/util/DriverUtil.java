...
public class DriverUtil {
	...
	public static AndroidDriver launchInstalledApp(String appPkg , String appActvt) throws Exception {
		...
		options.setAppPackage(appPkg);
		options.setAppActivity(appActvt);
